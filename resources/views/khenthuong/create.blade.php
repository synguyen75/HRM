...
@section('content')
    @if ($errors->any())
        ...
        @endforeach
    @endif
    <form enctype="multipart/form-data" method="POST" action="{{ route('khenthuong.store') }}">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" value="{{ now()->format('Y-m-d') }}" name="ngay_khen_thuong"
